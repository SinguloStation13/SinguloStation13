...
<<<<<<< HEAD:code/modules/tgui/tgui_input_text.dm
	.["preferences"] = list()
...
>>>>>>> 1c30727c7d (TGUI Core Updates (#8943)):code/modules/tgui_input/text.dm
	.["title"] = title
		...
		if("submit")
			if(max_length)
				...
				if(encode && (length(html_encode(params["entry"])) > max_length))
					to_chat(usr, "<span class='notice'>Input uses special characters, thus reducing the maximum length.</span>")
