...
/obj/item/paper/fluff/jobs/medical/hippocratic
	...
	default_raw_text = {"<i>I swear to fulfill, to the best of my ability and judgment, this covenant:
	<br>
...
/obj/item/paper/fluff/stations/glowstation/vault
	...
	<p>signed: <strong><em>Kevin Firewind</em></strong></p>\
	<p>Glory to Nanotrasen</p>"
>>>>>>> d85f45cbef (Re-PR HoP Expansion Pack (#8821))
