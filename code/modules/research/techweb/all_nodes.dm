...
>>>>>>> 2b5ddf01a0 (Splits node design IDs into multiple lines in alphabetical order with trailing commas  (#9091))
...
<<<<<<< HEAD
	...
	design_ids = list("fakedeath_nanites","aggressive_nanites","defib_nanites","regenerative_plus_nanites","brainheal_plus_nanites","purging_plus_nanites", "sensor_species_nanites","adrenaline_nanites", "nanite_heart") //Singulostation edit - Added nanite heart
=======
	prereq_ids = list(
		"nanite_bio",
		"nanite_mesh",
