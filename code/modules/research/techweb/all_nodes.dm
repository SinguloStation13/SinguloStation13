...
/datum/techweb_node/cryotech
	...
	design_ids = list("splitbeaker", "cryotube", "cryo_Grenade", "stasis", "cryogenicpod", "cryogenicpodcontrol") // SinguloStation13 Edit (Cryogenic freezers change - added cryogenic pods to research)
...
/datum/techweb_node/botany
	...
	prereq_ids = list("adv_engi", "biotech")
	design_ids = list("diskplantgene", "portaseeder", "flora_gun", "hydro_tray", "biogenerator", "seed_extractor", "plantgenes") //Singulostation edit -- Added "plantgenes"
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
	export_price = 5000
