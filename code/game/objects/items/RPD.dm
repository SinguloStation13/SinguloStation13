...
GLOBAL_LIST_INIT(transit_tube_recipes, list(
	...
	"Station Equipment" = list(
		...
		new /datum/pipe_info/transit("Terminus Tube Dispenser Station",		/obj/structure/c_transit_tube/station/dispenser/reverse, PIPE_UNARY), //Singulostation edit - Buildable transit tube dispenser station
