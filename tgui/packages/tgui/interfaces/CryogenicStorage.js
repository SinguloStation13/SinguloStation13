...
export const CryogenicStorage = (props, context) => {
  ...
  return (
    <Window title="Cryogenic Oversight Console" resizable width={400} height={300}>
      <Window.Content scrollable>
        <Section>
          <NoticeBox textAlign="center">
            You will be held in full liability for any damages to the occupant that you eject of your own accord.
          </NoticeBox>
          <Button icon="eject" color="bad" content="Eject All" onClick={() => act('eject_all')} />
        </Section>
